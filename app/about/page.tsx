...
export default function AboutPage() {
    return (
        <div className="grid grid-cols-5 gap-x-24 gap-y-32 text-lg items-center">
            ...
            <div className="col-span-2">
                <Image src={about2} alt="Family that manages StayWise" />
            </div>
            ...
            <div className="col-span-3">
                ...
                <div className="space-y-8">
                    ...
                    <div>
                        <Link
                            href="/cabins"
                            className="inline-block mt-4 bg-accent-500 px-8 py-5 text-primary-800 
                            text-lg font-semibold hover:bg-accent-600 transition-all"
                        >
